...
extern "C" JNIEXPORT jstring Java_org_telegram_hmsmsger_Utilities_readlink(JNIEnv *env, jclass clazz, jstring path) {
...
extern "C" JNIEXPORT jstring Java_org_telegram_hmsmsger_Utilities_readlinkFd(JNIEnv *env, jclass clazz, int fd) {

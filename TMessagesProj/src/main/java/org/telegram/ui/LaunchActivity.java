...
import org.telegram.hmsmsger.ContactsLoadingObserver;
...
import org.telegram.hmsmsger.LocationController;
...
import org.telegram.hmsmsger.camera.CameraController;
import org.telegram.hmsmsger.voip.VoIPPendingCall;
import org.telegram.hmsmsger.voip.VoIPService;
    ...
    private boolean handleIntent(Intent intent, boolean isNew, boolean restore, boolean fromPassword) {
        ...
        if ((flags & Intent.FLAG_ACTIVITY_LAUNCHED_FROM_HISTORY) == 0) {
            if (intent != null && intent.getAction() != null && !restore) {
                                ...
                                try (Cursor cursor = getContentResolver().query(intent.getData(), null, null, null, null)) {
                                    if (cursor != null) {
                                        if (cursor.moveToFirst()) {
                                            ...
                                            if (TextUtils.equals(mimeType, "vnd.android.cursor.item/vnd.org.telegram.hmsmsger.android.call")) {
                                                audioCallUser = true;
                                            } else if (TextUtils.equals(mimeType, "vnd.android.cursor.item/vnd.org.telegram.hmsmsger.android.call.video")) {
                                                videoCallUser = true;
                                            }
                                        }
                                    }
                ...
                } else if (intent.getAction().equals("org.telegram.hmsmsger.OPEN_ACCOUNT")) {
                    open_settings = 1;

...
public class ApplicationLoader extends Application {
    private static final String TAG = "HuaweiPushKit";
    ...
    public static File getFilesDirFixed() {
        ...
        return new File("/data/data/org.telegram.hmsmsger/files");
    }
        ...
        new Thread() {
            ...
            public void run() {
                try {
                    ...
                    String appId = AGConnectServicesConfig.fromContext(ApplicationLoader.this).getString("client/app_id");
                    String token = HmsInstanceId.getInstance(ApplicationLoader.this).getToken(appId, "HCM");

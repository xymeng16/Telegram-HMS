...
public class AndroidUtilities {
    ...
    public static boolean isStandaloneApp() {
        if (standaloneApp == null) {
            standaloneApp = "org.telegram.hmsmsger.web".equals(ApplicationLoader.applicationContext.getPackageName());
        }
    ...
    public static boolean isBetaApp() {
        if (betaApp == null) {
            betaApp = "org.telegram.hmsmsger.beta".equals(ApplicationLoader.applicationContext.getPackageName());
        }
        return betaApp;
    }

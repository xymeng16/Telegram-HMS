...
a_n = messaging.AndroidNotification(
    title="TEST",
    body="TEST",
...
def send_push_android_notify_message():
    ...
    message = messaging.Message(
        ...
        android=android,
        # TODO
        token=['IQAAAACy0hcnAABz0wZMcdL_HS_SEyB2dG4fQ9MrJcSllCJROEESwu69yYCOjfXXbqEWi9dKs6RVV1GF05SssM1ysqTi0BdzF2-qwuWuzxrV6OSd8A']
    )
    ...
    try:
        ...
        response = messaging.send_message(message, app_id="104248297")
...
def init_app():
    ...
    # TODO
    app_id = "104248297"
    app_secret = "6e38624bec2acf582cd31fc7bdb2e8aa5025ef90d511efc7daf0a32e73eea228"
    push_admin.initialize_app(app_id, app_secret)
    print("init_app finished")
